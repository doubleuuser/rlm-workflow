---
name: /rlm:init
description: Initialize a new RLM run with scaffolding and requirements template
disable-model-invocation: false
---

# /rlm:init - Initialize New RLM Run

## Usage

```
/rlm:init <run-id> [options]
```
...
```
/rlm:init 2026-02-21-add-oauth --template feature
```
