...
|----------|--------------|--------|
| **Codex** | `npx skills add` | ✅ Fully Supported |
| **Claude Code** | Plugin marketplace | ✅ Fully Supported |
| **OpenCode** | JavaScript plugin | ✅ Fully Supported |
| **Cursor** | Plugin marketplace | ✅ Fully Supported |
